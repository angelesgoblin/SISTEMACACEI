<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('Docente') }}
            {{ Form::label('rfc', $evaluaciondocente->rfc, ['class' => 'form-control' . ($errors->has('rfc') ? ' is-invalid' : ''), 'placeholder' => 'Docente']) }}
            {!! $errors->first('rfc', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <br>
        <div class="form-group">
            {{ Form::label('periodo') }}
            {{ Form::label('periodo', $evaluaciondocente->periodo, ['class' => 'form-control' . ($errors->has('periodo') ? ' is-invalid' : ''), 'placeholder' => 'Periodo']) }}
        ...
        <div class="form-group">
        @csrf 
        <label for="documento">  Formato de nombre del archivo: EvaluacionDocente_Periodo_Docente.pdf </label>
